...
**LUMI** is a VS Code extension that runs an approval-gated agent loop (Plan/Act, 63 tools, 4 providers) with **governed subagent swarms** (lock-necessity, merge gate, receipt schema v3) on top of **BroccoliDB** memory and structural proof.
...
| [Governed subagent execution](../governed-subagent-execution.md) | Swarm harness |
