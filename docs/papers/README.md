...
| 3 | [Whitepaper](whitepaper.md) | Engineers — *how* it is built | 45 min |

## One-line summary

**LUMI** is a VS Code extension that runs an approval-gated agent loop (Plan/Act, 62 tools, 4 providers) on top of **BroccoliDB** memory and structural proof.
...
│  Session · approval · LLM · tools · webview             │
│  src/ · webview-ui/                                     │
└───────────────────────────┬─────────────────────────────┘
                            │ @noorm/broccolidb
