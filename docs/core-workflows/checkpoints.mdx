...
Checkpoints make [auto-approve](/features/auto-approve) practical. Without checkpoints, auto-approve feels risky because LUMI can make many changes before you notice a problem. With checkpoints, you can let LUMI work autonomously and roll back if needed.
