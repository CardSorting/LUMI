---
title: "All DietCode Tools"
sidebarTitle: "All DietCode Tools"
description: "Complete reference for DietCode's built-in tools and capabilities."
---

DietCode has access to a set of tools for various tasks. This reference covers all available tools and how to use them.

## What Can DietCode Do?
...
MCP tools extend DietCode's capabilities through external integrations. See [MCP documentation](/mcp/mcp-overview) for details.
...
1. DietCode proposes creating a new task with summarized context
...
Type `/newtask` in chat to manually trigger this process. DietCode will:
...
For the most up-to-date implementation details, see the [DietCode repository](https://github.com/dietcode/dietcode/blob/main/src/core/prompts/system-prompt/tools).
