...
- **Zero trust architecture** - Your code never touches our servers. DietCode runs entirely client-side with your API keys.
- **Open source** - Every line of code on [GitHub](https://github.com/dietcode/dietcode). 50k+ stars from developers who use it daily.
