...
1. Click **Settings** (top right of DietCode chat)
...
-   **Switch to bash** (solves most instances)
    ...
    1. Within DietCode, left-click the **Settings** button in the top right-hand corner of the chat window
...
-   Select **"WSL Bash"** in DietCode settings, under **"Terminal Settings"**
