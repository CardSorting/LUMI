---
title: "Moonshot"
description: "Learn how to configure and use Moonshot AI's Kimi K2 models with DietCode. Access state-of-the-art MoE models with large context windows."
---
...
DietCode supports the following Moonshot models:
