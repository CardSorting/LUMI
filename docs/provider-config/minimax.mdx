---
title: "MiniMax"
description: "Learn how to configure and use MiniMax models with DietCode. Access MiniMax-M2 series models with large context windows, prompt caching, and reasoning support."
---
...
DietCode supports the following MiniMax models:
