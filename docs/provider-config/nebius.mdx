...
description: "Learn how to configure and use Nebius AI Studio with DietCode. Access DeepSeek, Qwen, Llama, and other open-source models with competitive pricing."
---
...
DietCode supports the following Nebius models:
