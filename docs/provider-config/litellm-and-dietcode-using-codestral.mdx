---
title: "LiteLLM & LUMI (using Codestral)"
description: "Learn how to set up and run LiteLLM with LUMI using the Codestral model. This guide covers Docker setup, configuration, and integration with LUMI."
---

### Using LiteLLM with LUMI

This guide demonstrates how to run a demo for LiteLLM starting with the Codestral model for use with LUMI.
...
2. **Setup LUMI**
    ...
    Once the LiteLLM server is up and running you can set it up in LUMI:
...
-   [LUMI Discord Community](https://discord.gg/dietcode)
