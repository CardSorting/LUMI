---
title: "LiteLLM & DietCode (using Codestral)"
description: "Learn how to set up and run LiteLLM with DietCode using the Codestral model. This guide covers Docker setup, configuration, and integration with DietCode."
---

### Using LiteLLM with DietCode

This guide demonstrates how to run a demo for LiteLLM starting with the Codestral model for use with DietCode.
...
2. **Setup DietCode**
    ...
    Once the LiteLLM server is up and running you can set it up in DietCode:
...
-   [DietCode Discord Community](https://discord.gg/dietcode)
