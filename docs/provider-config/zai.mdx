---
title: "Z AI (Zhipu AI)"
description: "Learn how to configure and use Z AI's GLM models with DietCode. Experience advanced hybrid reasoning, agentic capabilities, and open-source excellence with regional optimization."
---
...
### Configuration in DietCode

1.  **Open DietCode Settings:** Click the settings icon (⚙️) in the DietCode panel.
...
- Works exclusively through coding tools like DietCode
...
<Frame>
  <img src="https://storage.googleapis.com/dietcode_public_images/docs/assets/zAI-coding-plan.png" alt="zAI subscription page showing GLM Coding Lite and Pro plans with pricing" />
</Frame>

#### Setting up GLM Coding Plans

To use the GLM Coding Plans with DietCode:
...
3. **Configure in DietCode:** Open DietCode settings, select "Z AI" as your provider, and paste your API key into the "Z AI API Key" field.

<Frame>
  <img src="https://storage.googleapis.com/dietcode_public_images/docs/assets/zAI-provider.png" alt="DietCode settings with zAI provider selected and API key field highlighted" />
</Frame>

The setup connects your subscription directly to DietCode, giving you access to GLM-4.5's tool-calling capabilities optimized for coding workflows.
