...
<Steps>
  ...
  <Step title="Select Your Model">
    Once authorized, you'll be returned to LUMI. Choose your desired model from the **"Model"** dropdown.
  </Step>
</Steps>
