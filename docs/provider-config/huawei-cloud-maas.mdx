...
description: "Learn how to configure and use Huawei Cloud Model-as-a-Service with DietCode. Access DeepSeek and Qwen models through Huawei's cloud infrastructure."
---
...
DietCode supports the following Huawei Cloud MaaS models:
