---
title: "Qwen Code"
description: "Learn how to use Qwen Code with DietCode. Access free Qwen3 Coder models through the Qwen Code platform for coding tasks."
---
...
DietCode supports the following Qwen Code models (all free):
