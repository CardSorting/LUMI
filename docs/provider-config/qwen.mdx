---
title: "Alibaba Qwen"
description: "Learn how to configure and use Alibaba Cloud's Qwen models with DietCode. Access Qwen3 series models with thinking capabilities and extensive model options."
---
...
DietCode supports Qwen models with separate catalogs for International and China regions:
