...
description: "Install DietCode CLI on macOS, Linux, or Windows and configure your AI provider"
---

DietCode CLI brings the full power of DietCode to your terminal. In just a few minutes, you can install the CLI, authenticate with your preferred AI provider, and start running tasks from any directory on your machine.
...
# Moonshot
dietcode auth -p moonshot -k sk-xxxxx -m kimi-k2.5
