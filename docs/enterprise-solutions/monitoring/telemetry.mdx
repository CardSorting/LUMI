---
title: "DietCode Telemetry"
sidebarTitle: "DietCode Telemetry"
description: "Configure usage analytics and event tracking"
---

DietCode includes telemetry to help understand usage patterns and improve the product. Users can control whether to share this data.

## What is DietCode Telemetry?
...
### Enabling/Disabling DietCode Telemetry

Individual users can control telemetry through DietCode settings:

1. Open DietCode settings
2. Find "DietCode Telemetry" toggle
...
When telemetry is enabled, DietCode captures:
...
DietCode Telemetry **never** includes:
...
<Note>
Even with enterprise configuration, individual users can still disable DietCode Telemetry in their local settings.
</Note>

## Advanced Monitoring

For organizations needing detailed monitoring, DietCode supports optional OpenTelemetry integration to export telemetry data to your own observability systems.

See [Enterprise Monitoring](/enterprise-solutions/monitoring/overview) for details on available monitoring options.

## Privacy

DietCode's telemetry is designed with privacy in mind:
