...
<Tip>
API keys are stored locally in VS Code and are only used by the DietCode extension.
</Tip>
</Accordion>
...
Send a test message in DietCode to verify your connection works correctly with the LiteLLM proxy.
...
Confirm you're signed into the correct DietCode organization. Verify your administrator has saved the LiteLLM configuration and that you have the latest version of the DietCode extension.
...
- Regularly update the DietCode extension for security patches
