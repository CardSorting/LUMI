...
Focus Chain is automatic todo list management with real-time progress tracking. It helps DietCode work on longer tasks by maintaining a visible checklist that persists across context window resets.

<Frame>
	<img
		src="https://storage.googleapis.com/dietcode_public_images/docs/assets/2dos.gif"
...
- Work where you want visibility into DietCode's plan
...
1. Click the gear icon in the DietCode sidebar
2. Navigate to "Features"
3. Check "Enable Focus Chain"
4. Optionally adjust "Remind DietCode Interval" (default: 6 messages)

| Setting | Default | Description |
|---------|---------|-------------|
| Enable Focus Chain | Disabled | Enables enhanced task progress tracking |
| Remind DietCode Interval | 6 | How often DietCode updates the todo list (1-100 messages) |

## How It Works

When you start a task with Focus Chain enabled, DietCode:
...
Need to adjust the plan? Click the edit button in the expanded todo view. A markdown file opens in your editor where you can add, remove, or reorder items. Save the file and DietCode automatically detects your updates.
