...
description: "Templates for different types of DietCode documentation"
---
...
Use this template when explaining a DietCode feature. Focus on what it does, how to use it, and real examples.
...
- DietCode installed and configured
- [Other requirement]
...
### Example: DietCode Tools Guide

The [DietCode Tools Guide](/tools-reference/all-dietcode-tools) follows this pattern:
...
<Tip>
  ...
  DietCode helps you fill in each section based on your project.
</Tip>
