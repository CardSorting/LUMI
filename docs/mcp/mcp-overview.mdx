...
| Tool handler | `src/core/task/tools/handlers/UseMcpToolHandler.ts` | Executes MCP tools with approval/auto-approve |
...
See [SECURITY_BEST_PRACTICES](/SECURITY_BEST_PRACTICES) for approval gates on MCP tool calls.
