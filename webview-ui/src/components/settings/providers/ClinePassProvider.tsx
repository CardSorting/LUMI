import { clinePassModels } from "@shared/api"
...
/**
 * Props for the ClinePassProvider component
 */
...
/**
 * The ClinePass provider configuration component
 */
					...
					<ModelSelector
						...
						onChange={(e: any) =>
							handleModeFieldChange(
								{ plan: "planModeClinePassModelId", act: "actModeClinePassModelId" },
								e.target.value,
								currentMode,
							)
						}
