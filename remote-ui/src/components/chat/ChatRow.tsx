			...
			switch (type) {
				...
				case "mistake_limit_reached":
					return [
						...
						<span className="text-error font-bold">DietCode is having trouble...</span>,
					]
				case "command":
					return [
						<TerminalIcon className="text-foreground size-2" />,
						<span className="font-bold text-foreground">DietCode wants to execute this command:</span>,
					]
				case "use_mcp_server":
				...
				case "followup":
					return [
						...
						<span className="font-bold text-foreground">DietCode has a question:</span>,
					]
				default:
					return [null, null]
			}
