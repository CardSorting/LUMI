	...
	const renderErrorContent = () => {
		switch (errorType) {
			...
			case "mistake_limit_reached":
				...
				if (rawApiError) {
					// FIXME: DietCodeError parsing should not be applied to non-DietCode providers, but it seems we're using dietcodeErrorMessage below in the default error display
