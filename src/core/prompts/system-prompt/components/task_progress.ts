...
- The final item in every todo list MUST be "- [ ] Finalize Knowledge Ledger via run_finalization [Same-session]"
...
- [ ] Create components
- [ ] Test application
- [ ] Finalize Knowledge Ledger via run_finalization [Same-session]
</task_progress>
</execute_command>`
