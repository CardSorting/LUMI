...
/**
 * SovereignHealHandler: Applies high-fidelity AST repairs (PFH).
 */
export class SovereignHealHandler implements IToolHandler {
	readonly name = DietCodeDefaultTool.SOVEREIGN_HEAL
